...
Original file is located at
    https://colab.research.google.com/github/sharathsrini/Expirements/blob/master/latest.ipynb
"""
...
def check_closed(x, y, theta):
    ...
    return closed[(theta_to_stack_number(cell_theta))][int(cell_y)][int(cell_x)]
...
def set_closed(x, y, theta):
    ...
    closed[theta_to_stack_number(cell_theta)][int(cell_y)][int(cell_x)] = 1
...
current_state = state(0.0, 0.0, deg_to_rad(90.0), 0.0, 0.0, 0.0, 0.0)
...
if __name__== "__main__":
    ...
    plt.scatter([current_state.x, Goal.x], [current_state.y, Goal.y])
    search()
